...
import com.jd.bdp.mysql.tracker.avro.EventEntryAvro;
 ...
 */
public class HandlerNoParserMagpie implements MagpieExecutor {

    //tracker's log
    private Logger logger = LoggerFactory.getLogger(HandlerNoParserMagpie.class);
    ...
    //constructor
    public HandlerNoParserMagpie(TrackerConfiger configer) {
        this.configer = configer;
    }

    public HandlerNoParserMagpie(File file) throws IOException {
        if(file.exists()) {
