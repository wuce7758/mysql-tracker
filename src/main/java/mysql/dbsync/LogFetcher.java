...
/**
 * Declaration a binary-log fetcher. It extends from <code>mysql.dbsync.LogBuffer</code>.
 * 
 * <pre>
 * mysql.dbsync.LogFetcher fetcher = new SomeLogFetcher();
 * ...
 * 
 * while (fetcher.fetch())
 * {
...
public abstract class LogFetcher extends LogBuffer implements Closeable
{
    ...
    /**
     * Increases the capacity of this <tt>mysql.dbsync.LogFetcher</tt> instance, if
