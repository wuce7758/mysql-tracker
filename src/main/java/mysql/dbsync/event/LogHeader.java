...
public final class LogHeader
{
    ...
    */
            ...
            FormatDescriptionLogEvent descriptionEvent)
    {
        ...
        type = buffer.getUint8(); // mysql.dbsync.LogEvent.EVENT_TYPE_OFFSET;
        serverId = buffer.getUint32(); // mysql.dbsync.LogEvent.SERVER_ID_OFFSET;
        eventLen = (int) buffer.getUint32(); // mysql.dbsync.LogEvent.EVENT_LEN_OFFSET;
        ...
        /* 4.0 or newer */
        logPos = buffer.getUint32(); // mysql.dbsync.LogEvent.LOG_POS_OFFSET
        /*
        ...
        */
        ...
        flags = buffer.getUint16(); // mysql.dbsync.LogEvent.FLAGS_OFFSET
