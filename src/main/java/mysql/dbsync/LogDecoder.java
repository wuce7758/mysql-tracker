package mysql.dbsync;

import mysql.dbsync.event.AppendBlockLogEvent;
import mysql.dbsync.event.BeginLoadQueryLogEvent;
import mysql.dbsync.event.CreateFileLogEvent;
import mysql.dbsync.event.DeleteFileLogEvent;
import mysql.dbsync.event.DeleteRowsLogEvent;
import mysql.dbsync.event.ExecuteLoadLogEvent;
import mysql.dbsync.event.ExecuteLoadQueryLogEvent;
import mysql.dbsync.event.FormatDescriptionLogEvent;
import mysql.dbsync.event.GtidLogEvent;
import mysql.dbsync.event.HeartbeatLogEvent;
import mysql.dbsync.event.IgnorableLogEvent;
import mysql.dbsync.event.IncidentLogEvent;
import mysql.dbsync.event.IntvarLogEvent;
import mysql.dbsync.event.LoadLogEvent;
import mysql.dbsync.event.LogHeader;
import mysql.dbsync.event.PreviousGtidsLogEvent;
import mysql.dbsync.event.QueryLogEvent;
import mysql.dbsync.event.RandLogEvent;
import mysql.dbsync.event.RotateLogEvent;
import mysql.dbsync.event.RowsLogEvent;
import mysql.dbsync.event.RowsQueryLogEvent;
import mysql.dbsync.event.StartLogEventV3;
import mysql.dbsync.event.StopLogEvent;
import mysql.dbsync.event.TableMapLogEvent;
import mysql.dbsync.event.UnknownLogEvent;
import mysql.dbsync.event.UpdateRowsLogEvent;
import mysql.dbsync.event.UserVarLogEvent;
import mysql.dbsync.event.WriteRowsLogEvent;
import mysql.dbsync.event.XidLogEvent;
import mysql.dbsync.event.mariadb.AnnotateRowsEvent;
import mysql.dbsync.event.mariadb.BinlogCheckPointLogEvent;
import mysql.dbsync.event.mariadb.MariaGtidListLogEvent;
import mysql.dbsync.event.mariadb.MariaGtidLogEvent;
 ...
 * 
 * <pre>
 * mysql.dbsync.LogDecoder decoder = new mysql.dbsync.LogDecoder();
 * decoder.handle(...);
 * 
 * mysql.dbsync.LogEvent mysql.dbsync.event;
 * do
 * {
