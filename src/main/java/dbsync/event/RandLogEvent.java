 ...
 * does not need it (it's repeatable again) so this dbsync.event needn't be written in
 ...
 * Binary Format
 * 
 * The Post-Header for this dbsync.event type is empty. The Body has two components:
 * 
 * <table>
