...
public abstract class RowsLogEvent extends LogEvent
{
     ...
     * determined by the size of the dbsync.event. Each row has the following format:
     * 
     * <ul>
    ...
    /** Last dbsync.event of a statement */
    ...
    /**
     * Indicates that rows in this dbsync.event are complete, that is contain values
