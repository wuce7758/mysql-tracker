...
public final class RotateLogEvent extends LogEvent
{
     ...
     * 
     * <ul>
     * <li>8 bytes. The position of the first dbsync.event in the next log file. Always
     * contains the number 4 (meaning the next dbsync.event starts at position 4 in the
     ...
     * Its length is the dbsync.event size minus the size of the fixed parts.</li>
     * </ul>
     * 
    ...
    /* Rotate dbsync.event post-header */
