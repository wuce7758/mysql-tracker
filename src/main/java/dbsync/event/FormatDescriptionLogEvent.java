...
/**
 * For binlog version 4. This dbsync.event is saved by threads which read it, as they need it for future use (to decode the
 * ordinary events).
 * 
...
public final class FormatDescriptionLogEvent extends StartLogEventV3 {
    ...
    public FormatDescriptionLogEvent(LogHeader header, LogBuffer buffer, FormatDescriptionLogEvent descriptionEvent)
        ...
        {
            throw new IOException("Format Description dbsync.event header length is too short");
        }
    ...
    public FormatDescriptionLogEvent(final int binlogVersion){
        ...
        switch (binlogVersion) {
            case 4: /* MySQL 5.0 */
                ...
                /* Note: all dbsync.event types must explicitly fill in their lengths here. */
            ...
            case 3: /* 4.0.x x>=2 */
                /*
                 * We build an artificial (i.e. not sent by the master) dbsync.event, which describes what those old master
                 * versions send.
                 */
                serverVersion = "4.0";
                ...
                /*
                 * The first new dbsync.event in binlog version 4 is Format_desc. So any dbsync.event type after that does not exist
