...
/**
 * Declaration a binary-log fetcher. It extends from <code>dbsync.LogBuffer</code>.
 * 
 * <pre>
 * dbsync.LogFetcher fetcher = new SomeLogFetcher();
 * ...
 * 
 * while (fetcher.fetch())
 * {
 ...
 *     do
 *     {
 *         dbsync.event = decoder.decode(fetcher, context);
 * 
...
public abstract class LogFetcher extends LogBuffer implements Closeable
{
    ...
    /**
     * Increases the capacity of this <tt>dbsync.LogFetcher</tt> instance, if
